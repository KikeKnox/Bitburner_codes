...
export async function main(ns) {
	...
	var homeHacks = (ns.getServer("home").maxRam - 15) / (plyCores * ns.getScriptRam("kike.js","home")); //Dejo 15 de RAM libre para otros programas
	var serTemp;
	var i = 0;
	var n;
	...
	while(homeHacks < servis.length && plyCores > 1){
		...
		plyCores--;
		homeHacks = (ns.getServer("home").maxRam - 15) / (plyCores * ns.getScriptRam("kike.js","home"));
	}
